// Context Users Hook
// Manages users with access to a specific context
...
export interface UseContextUsersReturn {
  users: UserAccess[];
  isLoading: boolean;
  error: string | null;
  searchQuery: string;
...
export function useContextUsers(contextId: string): UseContextUsersReturn {
...
export { useContextUsers as useUsers };
export type { UseContextUsersReturn as UseUsersReturn };
