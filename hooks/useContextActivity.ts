// Context Activity Hook
// Manages activity log for a specific context
...
export interface UseContextActivityReturn {
...
export function useContextActivity(contextId: string): UseContextActivityReturn {
...
export { useContextActivity as useActivity };
export type { UseContextActivityReturn as UseActivityReturn };
